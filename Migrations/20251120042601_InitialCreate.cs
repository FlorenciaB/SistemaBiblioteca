        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroCatalogo = table.Column<string>(type: "TEXT", nullable: false),
                    Titulo = table.Column<string>(type: "TEXT", nullable: false),
                    Autor = table.Column<string>(type: "TEXT", nullable: false),
                    Editorial = table.Column<string>(type: "TEXT", nullable: false),
                    AnioEdicion = table.Column<int>(type: "INTEGER", nullable: true),
                    Cantidad = table.Column<int>(type: "INTEGER", nullable: false),
                    Procedencia = table.Column<string>(type: "TEXT", nullable: false),
                    Materias = table.Column<string>(type: "TEXT", nullable: true),
                    SubmateriaLengua = table.Column<string>(type: "TEXT", nullable: true),
                    TipoSoporte = table.Column<string>(type: "TEXT", nullable: true),
                    SubtipoSoporteLibro = table.Column<string>(type: "TEXT", nullable: true),
                    Grado = table.Column<string>(type: "TEXT", nullable: true),
                    Ubicacion = table.Column<string>(type: "TEXT", nullable: false),
                    LibroAula = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialBibliograficoId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Materias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Materias_MaterialesBibliograficos_MaterialBibliograficoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreNino = table.Column<string>(type: "TEXT", nullable: false),
                    ApellidoNino = table.Column<string>(type: "TEXT", nullable: false),
                    GradoNino = table.Column<string>(type: "TEXT", nullable: false),
                    FechaPrestamo = table.Column<DateTime>(type: "TEXT", nullable: false),
                    FechaLimiteDevolucion = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materias_MaterialBibliograficoId",
                table: "Materias",
